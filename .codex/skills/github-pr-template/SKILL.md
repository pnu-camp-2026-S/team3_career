...
description: Draft and open FitFolio GitHub pull requests using the team's Korean PR template, self-assignment rule, issue linkage, and verification summary. Use when Codex is asked to open, prepare, write, update, or summarize a PR; when the user says "PR 올려줘", "PR 설명 작성", "이번 PR 요약"; or when publishing changes to GitHub for this project.
---
...
Use this skill whenever preparing, opening, or updating a Pull Request for FitFolio.
...
8. Always assign the Pull Request to yourself after creating or updating it.
   - With GitHub CLI in PowerShell, run `gh pr edit <PR_NUMBER_OR_URL> --add-assignee '@me'`.
   - Verify with `gh pr view <PR_NUMBER_OR_URL> --json assignees`.
...
When creating and assigning a PR with GitHub CLI in PowerShell, use:

```powershell
gh pr create --base main --head <branch> --title "<title>" --body <body>
gh pr edit <PR_NUMBER_OR_URL> --add-assignee '@me'
gh pr view <PR_NUMBER_OR_URL> --json assignees
```
