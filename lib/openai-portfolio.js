...
function buildMockOnePageData(context) {
  const mainExperience = firstValue(context.experiences, '파일관리 기반 프로젝트 경험');
...
function buildMockDetailData(context) {
  const mainExperience = firstValue(context.experiences, '대표 프로젝트 경험');
  const mainKeyword = firstValue(context.keywords, '문제 해결');
...
function buildMockCoverLetterData(context) {
  const mainExperience = firstValue(context.experiences, '대표 경험');
  const mainKeyword = firstValue(context.keywords, '문제 해결');
