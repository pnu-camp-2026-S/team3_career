...
export function buildPortfolioPrompt({ format, purpose, major, experiences, experienceProjects = [], keywords, myPageInfo }) {
...
[근거 사용 규칙]
1. 선택 프로젝트 분석 summary JSON이 있으면 이를 가장 우선 근거로 사용하세요.
2. summaryMd와 summaryKeywords에 없는 역할, 성과, 수치, 기술 사용 경험은 새로 만들지 마세요.
